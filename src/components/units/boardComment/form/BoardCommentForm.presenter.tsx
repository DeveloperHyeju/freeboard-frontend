...
const BoardCommentFormUI = ({onChangeWriter, onChangePassword, onChangeContents, onClickCreateBoardComment, onClickUpdateBoardComment, writer, password, contents, isEdit, comment}: IBoardCommentFormUIProps) => {
