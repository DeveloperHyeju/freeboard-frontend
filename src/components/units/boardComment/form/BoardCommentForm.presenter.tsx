      ...
      <style.Contents>
        ...
        <style.ButtonBox>
          ...
          {isEdit ? (
            ...
            <style.StoreCommentButton onClick={onClickCreateBoardComment}>
              등록하기
            </style.StoreCommentButton>
          )}
        </style.ButtonBox>
