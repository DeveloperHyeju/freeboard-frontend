...
} from "./BoardCommentForm.queries";
import {
  IBoardCommentFormProps,
  IUpdateBoardCommentVriables,
} from "./BoardCommentForm.types";
...
const BoardCommentForm = ({
  ...
  const onClickUpdateBoardComment = async () => {
    ...
    if (contents)
      updateBoardCommentVariables.updateBoardCommentInput.contents = contents;
    if (rating)
      updateBoardCommentVariables.updateBoardCommentInput.rating = rating;
